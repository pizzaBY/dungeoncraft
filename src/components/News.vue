<template>
  ...
  <div class="container">
    <div class="row">
      <div class="col-8">
        <div class="card-block" v-for="item in news" :key="item.news_id">
          <div class="card-body">
            <div class="d-flex">
              <img
